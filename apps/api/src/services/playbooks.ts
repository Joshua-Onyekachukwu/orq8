    ...
    plan: {
      ...
      agents: [
        ...
        },
        {
          ...
          responsibilities: ['Scope technical work', 'Build and ship the MVP', 'Review and test code'],
      ...
      tasks: [
        ...
        { title: 'Define the MVP technical scope', description: 'Break the core product into a buildable first version.', goalIndex: 1, agentRole: 'Engineering Agent', priority: 'high' },

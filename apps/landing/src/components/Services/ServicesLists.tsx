...
const ServicesLists: React.FC = () => {
  const services: ServiceItem[] = [
    ...
    {
      id: 4,
      title: "Spending Insights & Budgeting",
      description:
        "Gain real-time insights into your spending habits and set smart budgets to stay financially healthy.",
    ...
    },
    {
      ...
      description:
        "Set and track savings goals like vacations, emergency funds, or debt payoff with progress updates.",
    ...
    },
    {
      ...
      description:
        "Stay protected with intelligent monitoring that alerts you instantly about suspicious or unauthorized activity.",

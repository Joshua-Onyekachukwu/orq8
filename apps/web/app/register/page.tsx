      ...
      <div id="main" className="flex min-h-screen bg-white">
        ...
        <div className="hidden w-1/2 flex-col justify-between bg-navy-950 p-10 lg:flex">
          ...
          <div className="max-w-md">
            <h2 className="mb-4 text-3xl font-light leading-tight text-white">
              The first cohort is{" "}
              <span className="text-emerald">almost ready</span>
            </h2>
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-6 py-12">
          ...
          <div className="w-full max-w-sm text-center">
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full border border-emerald/20 bg-emerald/5">
              <svg
            ...
            <h1 className="mb-3 text-2xl font-semibold text-navy-950">
            ...
            <div className="flex flex-col gap-3">
              <Link
                href="/#waitlist"
                className="inline-flex h-11 items-center justify-center rounded-full bg-emerald px-8 text-sm font-semibold text-white transition-colors hover:bg-emerald/90"
              >
                Join the waitlist
              </Link>
              <Link
                href="/"
                className="inline-flex h-11 items-center justify-center rounded-full border border-gray-200 px-8 text-sm font-medium text-gray-600 transition-colors hover:text-navy-950"
              >
                Back to home
              </Link>
            </div>
    ...
    <div id="main" className="flex min-h-screen bg-white">
      ...
      <div className="hidden w-1/2 flex-col justify-between bg-navy-950 p-10 lg:flex">
        ...
        <div className="max-w-md">
          <h2 className="mb-4 text-3xl font-light leading-tight text-white">
            You stay the CEO.{" "}
            <span className="text-emerald">The system runs.</span>
          </h2>
          <p className="text-sm leading-relaxed text-white/50">

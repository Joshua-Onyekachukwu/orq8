      ...
      <div className="mx-auto max-w-[1200px] px-[20px] md:px-[24px]">
        <div className="grid grid-cols-1 gap-[40px] lg:grid-cols-2 lg:gap-[80px] items-start">
          ...
          <div>
            ...
            <p className="text-base text-white/50 leading-relaxed mb-[40px]">
            ...
            <div className="space-y-[24px]">
              <div className="flex items-center gap-[16px]">
                ...
                <div>
                  <p className="text-2sm text-white/40 mb-[2px]">Email</p>
                  <p className="text-md text-white">hello@orq8.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-[16px]">
                ...
                <div>
                  <p className="text-2sm text-white/40 mb-[2px]">Response time</p>
                  <p className="text-md text-white">Within 24 hours</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[16px] border border-white/[0.06] bg-white/[0.03] p-[32px] md:p-[40px]">
            {status === "done" ? (
              <div className="py-[40px] text-center">
                ...
                <p className="mt-[8px] text-sm text-white/50">
              ...
              <form onSubmit={handleSubmit} className="space-y-[20px]">
                ...
                {status === "error" && (
                  <div className="rounded-[10px] border border-red-500/20 bg-red-500/10 px-[16px] py-[12px] text-sm text-red-400">

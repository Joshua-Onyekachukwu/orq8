      ...
      <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
        <div className="flex items-center relative flex-wrap lg:flex-nowrap justify-between">
          ...
          <div className="hidden lg:flex items-center grow basis-full">
            ...
            <Link href="/register" className="inline-block rounded-[60px] bg-orq8-orange px-[24px] py-[12px] uppercase text-[11px] font-bold text-white tracking-[1.8px] transition-all hover:bg-orq8-orange-dark"><span className="flex items-center justify-center gap-[12px]">Get Started <i className="ri-arrow-right-up-line w-[24px] h-[24px] rounded-full bg-white/15 text-white flex items-center justify-center text-2sm"></i></span></Link>
          </div>
          <div className={`bg-white rounded-[15px] border border-gray-200 mt-[20px] p-[20px] md:p-[30px] w-full hidden lg:!hidden ${mob?"":"active"}`} id="navbar-collapse">
            ...
            <Link href="/register" onClick={()=>setMob(true)} className="inline-block rounded-[60px] bg-orq8-orange px-[24px] py-[12px] uppercase text-[11px] font-bold text-white tracking-[1.8px] transition-all hover:bg-orq8-orange-dark mt-[15px]"><span className="flex items-center justify-center gap-[12px]">Get Started <i className="ri-arrow-right-up-line w-[24px] h-[24px] rounded-full bg-white/15 text-white flex items-center justify-center text-2sm"></i></span></Link>
          </div>
        </div>
      </div>
    </div>

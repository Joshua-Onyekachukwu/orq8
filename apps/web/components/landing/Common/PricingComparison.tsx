...
function CellValue({ value }: { value: string | boolean }) {
  if (typeof value === "boolean") {
    return value ? (
      <span className="inline-flex items-center justify-center w-[24px] h-[24px] rounded-full bg-[#B8FF66]/15">
        <svg className="w-[14px] h-[14px] text-[#1a5c2e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
  ...
  return <span className="text-[14px] text-[#1a5c2e] font-medium">{value}</span>;
}
    ...
    <div className="bg-white py-[40px] md:py-[60px] lg:py-[80px]">
      <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1200px] mx-auto px-[20px] md:px-[24px]">
        <div className="mb-[30px] md:mb-[40px] text-center">
          <span className="block uppercase font-bold tracking-[0.2em] text-[11px] text-[#E86A33] mb-[12px]">
            Compare plans
          </span>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-[16px] px-[20px] text-[13px] font-semibold text-gray-400 uppercase tracking-wider w-[35%]">
                  Feature
                </th>
                <th className="text-center py-[16px] px-[20px] w-[22%]">
                  <span className="text-[12px] font-bold uppercase tracking-wider text-[#E86A33]">Founder</span>
                  <span className="block text-[11px] text-gray-400 mt-[2px]">$39/mo</span>
                </th>
                <th className="text-center py-[16px] px-[20px] w-[22%] bg-[#1a5c2e]/[0.03] rounded-t-[8px]">
                  <span className="text-[12px] font-bold uppercase tracking-wider text-[#1a5c2e]">Team</span>
                  <span className="block text-[11px] text-gray-400 mt-[2px]">$99/mo</span>
                  <span className="inline-block mt-[4px] text-[9px] font-bold uppercase tracking-wider bg-[#E86A33] text-white px-[8px] py-[2px] rounded-full">Popular</span>
                </th>
                <th className="text-center py-[16px] px-[20px] w-[22%]">
                  <span className="text-[12px] font-bold uppercase tracking-wider text-[#E86A33]">Company</span>
            ...
            <tbody>
              {comparisonData.map((row, i) => (
                <tr key={i} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                  <td className="py-[14px] px-[20px] text-[14px] text-gray-600 font-medium">
                    {row.feature}
                  </td>
                  <td className="py-[14px] px-[20px] text-center">
                    <CellValue value={row.founder} />
                  </td>
                  <td className="py-[14px] px-[20px] text-center bg-[#1a5c2e]/[0.03]">
            ...
            <tfoot>
              <tr>
                ...
                <td className="py-[20px] px-[20px] text-center">
                  <Link href="/register" className="inline-block rounded-full border border-gray-200 px-[20px] py-[10px] text-[11px] font-bold uppercase tracking-wider text-gray-600 hover:border-[#1a5c2e] hover:text-[#1a5c2e] transition-colors">
                    Start free trial
                  </Link>
                </td>
                <td className="py-[20px] px-[20px] text-center bg-[#1a5c2e]/[0.03] rounded-b-[8px]">
                  <Link href="/register" className="inline-block rounded-full bg-[#1a5c2e] px-[20px] py-[10px] text-[11px] font-bold uppercase tracking-wider text-white hover:bg-[#174f27] transition-colors">
                    Start free trial
                  </Link>
                </td>
                <td className="py-[20px] px-[20px] text-center">
        ...
        <div className="md:hidden space-y-[20px]">
          {comparisonData.map((row, i) => (
            <div key={i} className="border-b border-gray-100 pb-[16px]">
              <p className="text-[13px] font-semibold text-gray-500 uppercase tracking-wider mb-[10px]">
                {row.feature}
              </p>
              <div className="grid grid-cols-3 gap-[12px]">
                <div className="text-center">
                  <p className="text-[10px] font-bold uppercase text-gray-400 mb-[4px]">Founder</p>
                  <CellValue value={row.founder} />
                </div>
                <div className="text-center bg-[#1a5c2e]/[0.03] rounded-[6px] py-[4px]">
                  <p className="text-[10px] font-bold uppercase text-[#1a5c2e] mb-[4px]">Team</p>
                  <CellValue value={row.team} />
                </div>
                <div className="text-center">
                  <p className="text-[10px] font-bold uppercase text-gray-400 mb-[4px]">Company</p>
                  <CellValue value={row.company} />
                </div>
              </div>
            </div>
